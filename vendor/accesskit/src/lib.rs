...
flag_methods! {
    ...
    /// Indicates that a text input currently contains text being composed by an input method.
    (TextInputMarked, is_text_input_marked, set_text_input_marked, clear_text_input_marked)
}
